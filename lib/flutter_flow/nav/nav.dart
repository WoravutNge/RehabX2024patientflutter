      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: PrescDetailWidget.routeName,
              path: PrescDetailWidget.routePath,
              requireAuth: true,
              builder: (context, params) => PrescDetailWidget(),
            ),
            FFRoute(
              name: ExerDetailWidget.routeName,
              path: ExerDetailWidget.routePath,
              requireAuth: true,
              builder: (context, params) => ExerDetailWidget(),
            ),
            FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/image_2025-03-23_165536002.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
